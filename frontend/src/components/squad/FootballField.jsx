          ...
          >
            {player ? (
              ...
              >
                ...
                >
                  <span className="text-white/35 group-hover:text-white/70 text-2xl font-thin leading-none transition-colors">+</span>
                </div>
                <span
                  className="text-[9px] font-black uppercase tracking-wider text-white/50 group-hover:text-white/80 px-2 py-0.5 transition-colors"
